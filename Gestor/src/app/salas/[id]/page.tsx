      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-zinc-100 tracking-tight">Status da {sala.nome}</h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-zinc-900/90 backdrop-blur-md p-5 rounded-xl border border-zinc-800/80 shadow-xl shadow-black/20">
        <div>
          <div className="flex items-start justify-between">
            <span className="text-[11px] font-semibold text-zinc-400 uppercase tracking-wider">Dispositivos Conectados</span>
        ...
        <div>
          <div className="flex items-start justify-between">
            <span className="text-[11px] font-semibold text-zinc-400 uppercase tracking-wider">Alunos em Atividade</span>
        ...
        <div>
          <div className="flex items-start justify-between">
            <span className="text-[11px] font-semibold text-zinc-400 uppercase tracking-wider">Apps Restritos em Uso</span>
        ...
        <div>
          <div className="flex items-start justify-between">
            <span className="text-[11px] font-semibold text-zinc-400 uppercase tracking-wider">Alertas de Sistema</span>
