...
const ICON_MAP: Record<string, React.ReactNode> = {
  ...
  hash: (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 9h16M4 15h16M6 4h2v16M16 4h2v16" />
    </svg>
  ),
  folder: (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  compass: (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M14.5 9.5l5 5-5 5-5-5 5-5z" />
    </svg>
  ),
};

export function AppRow({ app, onClick }: { app: { id: string; nome: string; subtexto: string; categoria: string; icone: string }; onClick: () => void }) {
  const icon = ICON_MAP[app.icone] || ICON_MAP["hash"];
  return (
    <button
      onClick={onClick}
